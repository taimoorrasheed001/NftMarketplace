                ...
                <div className="container">
                  ...
                  <div className="row g-4 align-items-end">
                    ...
                    <div className="col-12 col-sm-6 col-lg-3">
                      ...
                      <input className='input_class'  id="title" type="number" maxlength="4" size="1" placeholder="EUR" />

                      <label for="exampleInputEmail1" className="form-label ">Max</label>

                      <input className='input_class ms-4'  id="title" type="number"  placeholder="ETH" />
