  ...
  const sendFileToIPFS = async () => {
    ...
    try {
      ...
      const request = {
        ...
        headers: {
          'pinata_api_key': `1b3a595b52468a7b0b6c`,
          'pinata_secret_api_key': `d57d2a6151c176ed38df7fd53ca06a472f35d8b3d85e3b4ed4ae3cab7b582446`,
      ...
      const ipfsImageHash = response.data.IpfsHash;
      console.log("Successfully pinned IMAGE to IPFS : ", ipfsImageHash);

      // const ImgHash = `${resFile.data.IpfsHash}`;
      //console.log(ImgHash);

      //var imeg = `https://gateway.pinata.cloud/ipfs/${ImgHash}`
